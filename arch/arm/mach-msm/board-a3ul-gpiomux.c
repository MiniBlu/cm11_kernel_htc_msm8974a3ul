...
static struct gpiomux_setting debug_uart_active_config = {
		.func = GPIOMUX_FUNC_2,
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting debug_uart_suspend_config = {
		.func = GPIOMUX_FUNC_2,
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_DOWN,
		.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config debug_uart_configs[] __initdata = {
       {
               .gpio = 4,	
               .settings = {
                       [GPIOMUX_ACTIVE] = &debug_uart_active_config,
                       [GPIOMUX_SUSPENDED] = &debug_uart_suspend_config,
               },
       },
};

static struct gpiomux_setting ncgpio_config = {
		.func = GPIOMUX_FUNC_GPIO,
		.drv = GPIOMUX_DRV_2MA,
		.pull = GPIOMUX_PULL_DOWN,
		.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config ncgpio_configs[] __initdata = {
       {
               .gpio = 31,
               .settings = {
...
void __init msm8226_htc_init_gpiomux(void)
{
	...
	msm_gpiomux_install(ncgpio_configs, ARRAY_SIZE(ncgpio_configs));
